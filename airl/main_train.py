...
# Holds the training object and launches the simulation
class Trainer:
    def __init__(self):
        # Experience replay parameters
        self.initial_runs = 20000  # nb of simulations run at initialization
        self.max_exp_size = 300000  # limit on the nb of transitions in experience replay
        self.nb_simu = 50000000  # maximum nb of simulations to be run
        ...
        self.select_size = 16  # minibatch size
        self.update_rate = 4  # nb of simulations steps between policy updates
        self.weight_update_rate = 10000  # nb of simulations steps between target network updates
        self.model_save_rate = 5000  # save a copy of model to final regularly

        self.graph_rate = 500  # nb of simulations between dashboard plot
        self.keep_all_files = True  # keep all model .h5 and dashboard files
        self.n_eval = 100  # nb of simulations used for estimating the model performance

        self.n_aircraft = 1  # nb of aircraft initialized in the environment
        self.airspace_width = 1500  # Airspace width (meters)
        self.airspace_height = 1500  # Airspace height (meters)

        # Actions that the agent can select
        ...
        self.adaptive_reward = False  # normalize reward adaptively
        ...
        # number of simulation where eps decrease from init_eps to final_eps
        ...
        self.training_experience = []  # the experience replay data lives here
